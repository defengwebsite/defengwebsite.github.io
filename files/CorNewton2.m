...
%%%%%%%%
%%%%%%  based on the semismooth Newton-CG algorithm  in %%%%%
...
%%%%%%%  
%%%%%% Last modified date: April 30, 2012  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%                                                              %%%%%%%
...
%%%%%%           set tol =1.0e-6 if no very high accuracy required  %%%%%%%
...
%%%%%                          %%%%%%%%%%%%%%%
%%%%% Warning: The authors have no obligation to guarantee the solution quality!!!!! %%%%%%%%


function [X,y] = Correlation_Newton(G,b,tau,tol)
...
if nargin==4
   G  =  G-tau*eye(n); % reset G
   b0 = b0-tau*ones(n,1); % reset b0   
   error_tol = tol; %reset error tolerance
end
...
% save Cmat.mat C
 ...
 Initial_f = val_G - f0;
 fprintf('Semismooth Newton-CG: Initial Dual Objective Function value==== %d \n', Initial_f)
 fprintf('Semismooth Newton-CG: Norm of Gradient %d \n',norm_b)
 ...
 fprintf('Semismooth Newton-CG: Number of CG Iterations %d \n', iterk)
...
fprintf('Newton-CG: Final Original Objective Function value ====== %d \n', val_obj)
fprintf('Newton-CG: The rank of the Optimal Solution ================= %d \n',r)
...
fprintf('Newton-CG: computing time for  eigenvalue decompostions (calling mexeig time)==%d \n', eig_time)
fprintf('Newton-CG: computing time used for equal weight calibration ==== =====================%d \n',time_used)
